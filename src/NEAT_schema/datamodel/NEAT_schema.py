...
class SkLearnParams(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://w3id.org/neat_schema/SkLearnParams")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "SkLearnParams"
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/neat_schema/SkLearnParams")
...
class TFKerasParams(YAMLRoot):
    ...
    class_class_uri: ClassVar[URIRef] = URIRef("https://w3id.org/neat_schema/TFKerasParams")
    class_class_curie: ClassVar[str] = None
    class_name: ClassVar[str] = "TFKerasParams"
    class_model_uri: ClassVar[URIRef] = URIRef("https://w3id.org/neat_schema/TFKerasParams")
